...
export async function printHelp(): Promise<void> {
  ...
  process.stdout.write(
    [
      ...
      "  ares mind about [--limit N] [--json]   What I believe about you and this work, ranked by liveness.",
      "  ares mind edit <id> \"<text>\"          Correct a memory in place (confidence → 1).",
      "  ares mind forget <id>                Delete a memory on purpose.",
      ...
      "  ares friction --report|--gate  Headline metrics vs Aug 2026 baselines; --gate exits 3 on regression.",
      "  ares friction audit --install  Seed the weekly self-audit standing order (plan-only evidence goal).",
