// The vendor-neutral browser interface (Crix v5 / O6 / concept C6).
//
// Crix owns this interface; the engine (Playwright, Chrome MCP, …) is a
...
// so the rest of Crix never knows or cares which browser is underneath.
