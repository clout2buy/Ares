...
//
// A fresh Operator graph should not claim Crix has zero capability when the
...
export const NATIVE_CAPABILITY_SEEDS: readonly NativeCapabilitySeed[] = [
  { id: "native/read-files", name: "read local files", methods: [{ kind: "cli", ref: "Crix Read tool" }] },
  { id: "native/write-files", name: "write and edit workspace files", methods: [{ kind: "cli", ref: "Crix Write/Edit/ApplyIntent tools" }] },
  { id: "native/search-codebase", name: "search the codebase", methods: [{ kind: "cli", ref: "Crix Grep/Glob/CodebaseSearch tools" }] },
  { id: "native/run-shell", name: "run local shell commands", methods: [{ kind: "cli", ref: "PowerShell/Bash" }] },
  { id: "native/manage-processes", name: "launch and inspect long-running processes", methods: [{ kind: "cli", ref: "Crix BashOutput/KillShell tools" }] },
  { id: "native/use-browser", name: "drive a browser and capture visual proof", methods: [{ kind: "browser", ref: "Playwright BrowserConnector" }] },
  { id: "native/recall-memory", name: "recall and update living memory", methods: [{ kind: "cli", ref: "Crix LivingMind tool" }] },
  { id: "native/run-skills", name: "run local learned skills", methods: [{ kind: "skill", ref: "RunSkill" }] },
  { id: "native/manage-goals", name: "hold and run durable Operator goals", methods: [{ kind: "cli", ref: "Crix Operator tool" }] },
